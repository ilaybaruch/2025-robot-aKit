 ...
 */
public class TuneableElevatorFeedforward implements ProtobufSerializable, StructSerializable, Tuneable {
   ...
   */
  public TuneableElevatorFeedforward(double ks, double kg, double kv, double ka, double dtSeconds) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @throws IllegalArgumentException for ka &lt; zero.
   */
  public TuneableElevatorFeedforward(double ks, double kg, double kv, double ka) {
   ...
   * @throws IllegalArgumentException for kv &lt; zero.
   */
  public TuneableElevatorFeedforward(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
